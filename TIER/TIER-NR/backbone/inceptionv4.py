...
class InceptionV4(nn.Module):
    ...
    def logits(self, features):
        ...
        fea = F.avg_pool2d(features, kernel_size=adaptiveAvgPoolWidth)
        x = fea.view(fea.size(0), -1)
    ...
    def forward(self, input):
        ...
        fea, x = self.logits(x)
        return fea.squeeze(2).squeeze(2)
...
def inceptionv4(num_classes=1000, pretrained='imagenet'):
    if pretrained:
        ...
        save_model = torch.load('./pretrained/inceptionv4-8e4777a0.pth')
