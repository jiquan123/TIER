...
-  bert-base-uncased
-  bert-large-uncased
It can be download using this link: [[百度网盘](https://pan.baidu.com/s/19TDTIm6_0QJtm8N1YlfMjg) (提取码：text)]or be accessed on [huggingface] (https://huggingface.co/docs/transformers/installation).
