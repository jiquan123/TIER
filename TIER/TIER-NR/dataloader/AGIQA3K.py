...
def get_AGIQA3K_dataloaders(args):
    ...
    dataloaders['train'] = torch.utils.data.DataLoader(
        AGIQA3kDataset(train_image, train_label, train_text_prompt, train_transforms, text_encoder_path),
        batch_size=args.train_batch_size,
        shuffle=True,
        pin_memory=True)

    dataloaders['test'] = torch.utils.data.DataLoader(
        AGIQA3kDataset(test_image, test_label, test_text_prompt, test_transforms, text_encoder_path),
